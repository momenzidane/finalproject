        ...
        <div style="display: flex;" class="container2">
            ...
            <div class="collapse navbar-collapse"  id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="login.html" class="nav-link contact">Login</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="register_a.php">
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="register" id="save" class="form-submit" value="Register"/>
                            </div>
                        </form>
                    </div>
